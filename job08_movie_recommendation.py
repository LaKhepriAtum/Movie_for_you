...
#cos 0 = 1, cos 90 = 0, cos 180 = -1, -> 1에 가까우면 유사, -1에 가까우면 반대되는 단어
...
# 직접 문장 주기
sentence = '전두환 군부 독재 시절을 미화하는 영적화통일돼서 배에서 기생충 키우고 싶나? 뭔 북한넘들 미화 영화가 이렇게 많냐.배우들도 생각이 있으면 이런 영화는 걸러야하는 거 아니냐.박정희, 화에 출연하면 무식해보이 듯이,이런 북한 미화 영화 출연하는 것도 참으로 정신나간 듯이 보인다.제목도 강철비가 뭐냐. 김영환 강철서신에서 가져온거냐.정말 적당히 하자.'
# 전저리 하지 않았다.
